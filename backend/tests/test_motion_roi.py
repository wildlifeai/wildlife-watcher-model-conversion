...
from app.domain.motion_roi import compute_motion_roi, compute_motion_roi_per_frame
...
def test_motion_roi_per_frame_tracks_moving_square():
    ...
    ims = [_mk_frame(size=(640, 480), square=(120 + i * 30, 160, 180 + i * 30, 220)) for i in range(6)]
